...
results_folder="singles_100"
efname="runtime_errors"

[ -f "../output/singles/flows/${type}_${results_folder}" ] || mkdir -p "../output/singles/flows/${type}_${results_folder}"
[ -f "../output/singles/flows/${type}_${results_folder}/${efname}" ] || mkdir -p "../output/singles/flows/${type}_${results_folder}/${efname}"
error_folder="../output/singles/flows/${type}_${results_folder}/${efname}"

for f in ../output/singles/flows/**/*.pcap;
do
    x=$(basename $f .pcap)
